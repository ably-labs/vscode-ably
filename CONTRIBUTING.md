...
If you spot a problem, [search if an issue already exists](https://github.com/ably-labs/vscode-ably/issues). If a related issue doesn't exist, you can open a [new issue](https://github.com/ably-labs/vscode-ably/issues/new).

#### Solve an issue

Scan through our [existing issues](https://github.com/ably-labs/vscode-ably/issues) to find one that interests you. As a general rule, we don’t assign issues to anyone. If you find an issue to work on, you are welcome to open a PR with a fix.
...
- As you update your PR and apply changes, mark each conversation as [resolved](- As you update your PR and apply changes, mark each conversation as [resolved](https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/commenting-on-a-pull-request#resolving-conversations).
).
- If you run into any merge issues, checkout this [help article](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/addressing-merge-conflicts/about-merge-conflicts) to help you resolve merge conflicts and other issues.
